...
import cc.design7.pl9m.parse.ParseContext;
import cc.design7.pl9m.parse.ParseException;
import cc.design7.pl9m.parse.Token;
...
public final class ScannerTest {
    ...
    static {
        try (InputStream s = ScannerTest.class.getResourceAsStream("/resources/pl9m/example1.pl9")) {
            if (s == null) {
